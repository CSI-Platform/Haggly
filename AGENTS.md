...
This repository is the canonical CSI-Platform codebase for **Counterpart**, the active negotiation product formerly referred to as Haggly v2.
...
- Build Counterpart by CSI-Platform: a serious AI negotiation companion, "Grammarly for negotiation."
...
- Treat "Counterpart" as the working name under CSI-Platform. It is not cleared as a standalone public brand/domain/trademark.
